...
// emcc E:\mytest\BigData-Groupwork\momowanteat\content.cpp --preload-file assest -o content_c.js -s WASM=1 -s EXPORTED_FUNCTIONS="['_malloc', '_free','_getmark']" -s EXPORTED_RUNTIME_METHODS="['cwrap', 'ccall', 'getValue', 'setValue']"
